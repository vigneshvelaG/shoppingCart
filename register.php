        ...
        if($name!="" && $email!="" && $pwd!="" && $cpwd!="") {
            if($cpwd===$pwd) {
                ...
                if($count==0) {
                    ...
                    $sql_query = "INSERT INTO user(name,email,password) VALUES ('$name','$email','$pwd');";
                    $result = mysqli_query($conn,$sql_query);
                    if($result) {
...
<div class="registration-form">
  <form method="post" action=""> 
    ...
    <div class="action">
    <button style=" color: #30ADFF;" ><a style="text-decoration: none" href="login.php">Sign in</button>
