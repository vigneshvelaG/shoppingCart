        ...
        if($email!="" && $pwd!="") {
            $sql_query = "SELECT count(*) AS usercount FROM user WHERE email='$email';";
             ...
             $count = $row['usercount'];
                ...
                $sql_query = "SELECT name as username,password as pwd FROM user WHERE email='$email';";
                $result = mysqli_query($conn,$sql_query);
                $row = mysqli_fetch_array($result);
...
<div class="login-form">
  <form method="post" action=""> 
    ...
    <div class="content">
      ...
      <button type="submit" name="submit" value="submit" class="link">SUBMIT</button><br>
      <a href="#" class="link">Forgot Your Password?</a>
    </div>
    <div class="action">
      <button ><a style="text-decoration: none" href="login.php">Sign in</button>
      <button ><a style="text-decoration: none" href="register.php">Register</button>
    </div>
  </form>
</div>
<!-- partial -->
